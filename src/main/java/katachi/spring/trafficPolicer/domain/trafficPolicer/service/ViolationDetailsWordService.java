...
public class ViolationDetailsWordService {
	...
	public Map<String, String> getCarelessness() {
		...
		String LegallyProhibitedPlaces = mSource.getMessage("Legally.prohibited.places", null, Locale.JAPAN);
		...
		String RailroadCrossing = mSource.getMessage("Railroad.crossing", null, Locale.JAPAN);
		String roadSign = mSource.getMessage("roadSign", null, Locale.JAPAN);
		String SameTrafficZone = mSource.getMessage("Same.traffic.zone", null, Locale.JAPAN);
